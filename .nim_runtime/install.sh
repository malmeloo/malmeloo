...
if [ $# -eq 1 ] ; then
  ...
  cp "compiler/astyaml.nim" "$nimbleDir/compiler/astyaml.nim"
  chmod 644 "$nimbleDir/compiler/astyaml.nim"
  ...
  cp "compiler/cbuilder.nim" "$nimbleDir/compiler/cbuilder.nim"
  chmod 644 "$nimbleDir/compiler/cbuilder.nim"
  ...
  cp "compiler/expanddefaults.nim" "$nimbleDir/compiler/expanddefaults.nim"
  chmod 644 "$nimbleDir/compiler/expanddefaults.nim"
  ...
  cp "compiler/ic/iclineinfos.nim" "$nimbleDir/compiler/ic/iclineinfos.nim"
  chmod 644 "$nimbleDir/compiler/ic/iclineinfos.nim"
  ...
  cp "compiler/mangleutils.nim" "$nimbleDir/compiler/mangleutils.nim"
  chmod 644 "$nimbleDir/compiler/mangleutils.nim"
  ...
  cp "compiler/nodekinds.nim" "$nimbleDir/compiler/nodekinds.nim"
  chmod 644 "$nimbleDir/compiler/nodekinds.nim"
  ...
  cp "compiler/plugins/customast.nim" "$nimbleDir/compiler/plugins/customast.nim"
  chmod 644 "$nimbleDir/compiler/plugins/customast.nim"
  ...
  cp "compiler/plugins/plugins.nimble" "$nimbleDir/compiler/plugins/plugins.nimble"
  chmod 644 "$nimbleDir/compiler/plugins/plugins.nimble"
  ...
  cp "compiler/pushpoppragmas.nim" "$nimbleDir/compiler/pushpoppragmas.nim"
  chmod 644 "$nimbleDir/compiler/pushpoppragmas.nim"
  ...
  cp "compiler/suggestsymdb.nim" "$nimbleDir/compiler/suggestsymdb.nim"
  chmod 644 "$nimbleDir/compiler/suggestsymdb.nim"
  ...
  cp "compiler/vtables.nim" "$nimbleDir/compiler/vtables.nim"
  chmod 644 "$nimbleDir/compiler/vtables.nim"
